    ...
    <div className="flex flex-col items-center justify-center p-8 bg-white">
      <header className="flex items-center justify-between w-full max-w-6xl">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold">Avatar Maker</span>
        </div>
      ...
      <main className="flex flex-col items-center justify-center w-full max-w-4xl mt-12">
        <div className="flex flex-col items-center mb-8">
          <h1 className="text-2xl font-semibold">Choose your styles</h1>
          ...
          <Button className="mt-4" variant="outline">
            <ShuffleIcon className="h-5 w-5" /> Random
          </Button>
        </div>
        ...
        <div className="flex items-center justify-between w-full max-w-4xl mt-8">
          <Button variant="outline">
            <CodeIcon className="h-5 w-5" /> Embed
          </Button>
          <Button variant="outline">
